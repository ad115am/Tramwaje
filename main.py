...
def download_vehicle_positions_pb():
  ...
  for entity in feed.entity:
    ...
    if(get_only_trams(int(entity.vehicle.vehicle.id))):
      print(f'id: {entity.vehicle.vehicle.id} route_id: {entity.vehicle.trip.route_id} lat: {entity.vehicle.position.latitude} lon: {entity.vehicle.position.longitude} speed : {entity.vehicle.position.speed}')
